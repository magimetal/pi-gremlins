...
import { MockContainer, MockMarkdown, MockSpacer, MockText, parseFrontmatter } from "../helpers/test-helpers.js";
...
mock.module("typebox", () => ({
	Type: {
		...
		Boolean: (value = {}) => value,
		Integer: (value = {}) => value,
		Union: (values, options = {}) => ({ values, ...options }),
	},
}));
...
const { default: registerPiGremlins } = require("../../index.ts");
